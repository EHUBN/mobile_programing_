...
class StorySetting extends StatefulWidget {
  final List<Story> templates;
  final Story story;
  const StorySetting({super.key, required this.story, required this.templates});
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            title: const Text("Story Template"),
          ),
          body: SingleChildScrollView(
            child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text("  Template's name"),
                  _titleField(),
    ...
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: const Text("Settings won't be saved"),
      ...
      child: Form(
          ...
          child: TextFormField(
            ...
            validator: (input) {
              ...
              } else if(input != widget.ch.name && widget.story.characterList
      ...
      httpResponse = await http.post(Uri.parse(uri),
          ...
          body: jsonEncode({
            ...
            "messages": [
              {
                "role": "user",
                "content": "Is word '${input}' suitable for describing fictional story's background?"
              },
              {
                "role": "system",
                "content": "You should only answer 'y' or 'n'."
